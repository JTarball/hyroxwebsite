...
- Each phase is necessary so that you can see the greatest adaptation by focusing and not being too tired to work at the required intensity during a workout. 
...
*See article how maximum strength is a method for muscular endurance [here](/post/what-is-the-best-way-to-increase-your-muscular-endurance#max-strength)*

**The aim is to:**

- Make the demands of Hyrox easier

- Build the foundation to make your running, muscular endurance easier later.
...
[How to Structure your Hyrox Strength Cycle](/post/how-to-structure-your-hyrox-strength-cycle)
...
[How to Increase your Muscular Endurance](/post/what-is-the-best-way-to-increase-your-muscular-endurance)
...
**How:**
 - Do another Strength, Aerobic Block
 - Metabolic Conditioning/Hyrox Specific Block
...
{{< oembed "ig" "reel" "CeBi_49M8FO" "hidecaption" >}}
...
*e.g. Combined pushups with Xiaopeng Forward for mobility*
  ...
  * Warm Up could include mobility exercises: cat cow, shoulder delocates, band exercises.
...
- The first week would be a lot of intensity but less volume.

- The second week would be a drop in intensity but more volume, to build stamina..

- The third week would have two intensity sessions and the highest volume.

- The four week would be a deload.
...
Consider the diagram above trying to examine the factors affecting hyrox performance.
...
<div class="img-m">{{< youtube 5UOPwCWHk >}}</div>
...
- 2 weeks of inactivity has zero effect on mass or strength 
...
* Normally your annual plan includes:

  * preparation phase (could be building your aerobic base)
  * competitive phase
...
https://labcoatfitness.com/articles/programming-part-1-general-fundamentals-of-programming]